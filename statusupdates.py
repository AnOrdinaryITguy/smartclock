...
class GeneralUpdates:
    ...
    def UpdateWeather():
        ...
        try:
            ...
            WeatherStoringList.clear()
            WeatherStoringList.append(WeatherData(validtime = "null", forecast = "No Internet", temperature= "13:37"))
    def UpdateSLtimetables():
        ...
        try:
            ...
            SLStoringList.clear()
            SLStoringList.append(SLData(direction ="No Internet", displaytime="13:37"))
